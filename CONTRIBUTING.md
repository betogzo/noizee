...
git clone https://github.com/betogzo/noizee.git
cd noizee
...
| File | Purpose |
|------|---------|
| `Sources/Noizee/AppDelegate.swift` | Window lifecycle, background audio support |
| `Sources/Noizee/Services/WebKit/WebKitManager.swift` | Cookie store & persistence |
| `Sources/Noizee/Services/Auth/AuthService.swift` | Login state machine |
| `Sources/Noizee/Services/Player/PlayerService.swift` | Playback state & control |
| `Sources/Noizee/Views/MiniPlayerWebView.swift` | Singleton WebView, playback UI |
| `Sources/Noizee/Views/MainWindow.swift` | Main app window |
| `Sources/Noizee/Utilities/DiagnosticsLogger.swift` | Logging |
...
Reference: Sources/Noizee/Services/HapticService.swift for existing patterns
```
