...
struct AppLocalizationTests {
    ...
    private func sourceCatalogValue(key: String, localeIdentifier: String) throws -> String {
        ...
        let repositoryRoot = testFileURL
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
        let catalogURL = repositoryRoot.appendingPathComponent("Sources/Noizee/Resources/Localizable.xcstrings")
    ...
    @Test("Override bundle lookup is scoped to Noizee-owned bundles")
    func overrideBundleLookupIsScopedToNoizeeBundles() throws {
