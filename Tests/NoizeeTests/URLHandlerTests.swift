...
struct URLHandlerTests {
    ...
    @Test("Parse noizee://play URL extracts video ID")
    func parseNoizeePlayURL() throws {
        let url = try #require(URL(string: "noizee://play?v=abc123"))
        let result = URLHandler.parse(url)
    ...
    @Test("Parse noizee://playlist URL extracts playlist ID")
    func parseNoizeePlaylistURL() throws {
        let url = try #require(URL(string: "noizee://playlist?list=PLmylist"))
        let result = URLHandler.parse(url)
    ...
    @Test("Parse noizee://album URL extracts album ID")
    func parseNoizeeAlbumURL() throws {
        let url = try #require(URL(string: "noizee://album?id=MPREb_album"))
        let result = URLHandler.parse(url)
    ...
    @Test("Parse noizee://artist URL extracts artist ID")
    func parseNoizeeArtistURL() throws {
        let url = try #require(URL(string: "noizee://artist?id=UCchannel"))
        let result = URLHandler.parse(url)
