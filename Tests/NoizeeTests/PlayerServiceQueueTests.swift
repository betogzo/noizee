...
struct PlayerServiceQueueTests {
    ...
    init() {
        ...
        UserDefaults.standard.removeObject(forKey: "noizee.saved.queue")
        UserDefaults.standard.removeObject(forKey: "noizee.saved.queueIndex")
        UserDefaults.standard.removeObject(forKey: "noizee.saved.playbackSession")
    ...
    func restoreInvalidQueue() {
        ...
        UserDefaults.standard.set(Data("invalid data".utf8), forKey: "noizee.saved.queue")
        UserDefaults.standard.set(0, forKey: "noizee.saved.queueIndex")
        UserDefaults.standard.removeObject(forKey: "noizee.saved.playbackSession")
    ...
    func legacyQueuePersistenceFallback() throws {
        ...
        UserDefaults.standard.set(queueData, forKey: "noizee.saved.queue")
        UserDefaults.standard.set(1, forKey: "noizee.saved.queueIndex")
        UserDefaults.standard.removeObject(forKey: "noizee.saved.playbackSession")
    ...
    func queueDisplayModePersistence() {
        ...
        // Assert
        let savedMode = UserDefaults.standard.string(forKey: "noizee.queue.displayMode")
