...
//  Reads cookies from the Noizee app's debug cookie export for authenticated requests.
//
//  Usage:
...
/// Reads cookies from Noizee app's backup file in Application Support.
...
func loadCookiesFromAppBackup() -> [HTTPCookie]? {
    ...
    let cookieFile =
        appSupport
            .appendingPathComponent("Noizee", isDirectory: true)
...
func exploreBrowse(
    ...
    do {
        ...
        if statusCode == 401 || statusCode == 403 {
            ...
            print("   Run the Noizee app and sign in, then try again.")
            return
        }
...
func checkAuthStatus() {
    ...
    guard let cookies = loadCookiesFromAppBackup() else {
        ...
        print("  1. Run the Noizee app")
        print("  2. Sign in to YouTube Music")
        print("  3. The app will save cookies to ~/Library/Application Support/Noizee/")
...
func discoverAccounts(verbose: Bool) async {
    ...
    guard loadCookiesFromAppBackup() != nil else {
        print("❌ No cookies found. Please sign in to Noizee first.")
        return
    }
...
func showHelp() {
    print(
        ...
        Supports both public and authenticated endpoints (reads cookies from Noizee app).
        ...
        Examples:
          ...
          # Explore authenticated endpoints (requires Noizee sign-in)
          ...
          ./api-explorer.swift auth
            ...
            Authentication:
                ...
                Debug builds export auth cookies to:
                    ~/Library/Application Support/Noizee/cookies.dat
