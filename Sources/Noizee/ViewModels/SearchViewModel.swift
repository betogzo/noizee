...
final class SearchViewModel {
    ...
    var query: String = "" {
        didSet {
            // TextField bindings often re-assign the same string on focus/navigation; skipping
            // avoids cancelling an in-flight search started from the Home toolbar (or ⌘K route).
