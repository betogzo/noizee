...
/// Main entry point for the Noizee macOS application.
@available(macOS 26.0, *)
@main
struct NoizeeApp: App {
        ...
        Window("Noizee", id: "main") {
            ...
            if UITestConfig.isRunningUnitTests, !UITestConfig.isUITestMode {
                ...
                MainWindow(navigationSelection: self.$navigationSelection, client: self.sharedClient)
                    ...
                    .onAppear {
                        DiagnosticsLogger.app.info("NoizeeApp: App content appeared")
                    ...
                    .task {
                        DiagnosticsLogger.app.info("NoizeeApp: Root task started")
                        // Check if user is already logged in from previous session
                        await self.authService.checkLoginStatus()
                        DiagnosticsLogger.app.info("NoizeeApp: Login status check complete")
    ...
    private func showMainWindow() {
        ...
        for window in NSApplication.shared.windows where window.frameAutosaveName == "NoizeeMainWindow" {
