    ...
    var body: some View {
        ...
        Form {
            ...
            Section {
                ...
                Toggle("Hide Videos Shelves", isOn: self.$settings.hideVideosCategoryShelves)
                    .help("Remove YouTube Music Videos sections from All search and from Home, Explore, Charts, and similar browse pages")
            ...
            Section {
                ...
                Link(destination: URL(string: "https://github.com/betogzo/noizee")!) {
                    HStack {
                        Text("GitHub")
                        Spacer()
