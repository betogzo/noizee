    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("When enabled, Noizee can add richer queue analysis, AI-powered playlist refinement, and lyrics explanations. Basic command-bar controls still work without Apple Intelligence.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
            ...
            Section {
                ...
                Text("Noizee creates fresh AI sessions per request. Refresh the status if Apple Intelligence finishes downloading or becomes available while the app is open.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
