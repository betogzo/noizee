...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    /// Set by NoizeeApp after initialization.
    ...
    func applicationDidHide(_: Notification) {
        SingletonPlayerWebView.shared.refreshMediaSessionControlOverrides()
    }

    func applicationDidUnhide(_: Notification) {
        SingletonPlayerWebView.shared.refreshMediaSessionControlOverrides()
    }
    ...
    private func setupWindowDelegate() {
        ...
        for window in NSApplication.shared.windows where window.canBecomeMain {
            ...
            if window.frameAutosaveName.isEmpty {
                window.setFrameAutosaveName("NoizeeMainWindow")
            }
        ...
        if let mainWindow = self.mainWindow {
            NotificationCenter.default.addObserver(
                self,
                selector: #selector(self.mainWindowOcclusionDidChange),
    ...
    @objc private func mainWindowOcclusionDidChange() {
        SingletonPlayerWebView.shared.refreshMediaSessionControlOverrides()
    }
