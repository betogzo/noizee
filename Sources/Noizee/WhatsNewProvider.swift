...
enum WhatsNewProvider {
    ...
    static let fallbackCollection: [WhatsNew] = [
        WhatsNew(
            ...
            learnMoreURL: URL(string: "https://github.com/betogzo/noizee/releases")
        ),
    ]
    ...
    private static func parseRelease(data: Data) -> WhatsNew? {
        ...
        let title = name ?? "What's New in Noizee \(versionString)"
