...
enum KeychainCookieStorage {
    ...
    private static let service = "com.noizee.auth-cookies"
...
enum LegacyCookieMigration {
    ...
    enum DebugCookieFileExporter {
        ...
        private static var fileURL: URL? {
            ...
            let appFolder = appSupport.appendingPathComponent("Noizee", isDirectory: true)
            ...
            do {
                ...
                Self.logger.error("Failed to create Noizee folder: \(error.localizedDescription)")
                return nil
            }
