...
final class NotificationService {
    ...
    private func requestAuthorization() {
        // UNUserNotificationCenter crashes without an app bundle (e.g., `swift run`, unit tests)
        guard Bundle.main.isMacApplicationPackage, !UITestConfig.isRunningUnitTests else { return }
        Task {
            do {
