...
final class LastFMService: ScrobbleServiceProtocol {
    ...
    /// Configure via `NOIZEE_LASTFM_WORKER_URL` environment variable or Info.plist.
    ...
    init(
        ...
        } else if let envURL = ProcessInfo.processInfo.environment["NOIZEE_LASTFM_WORKER_URL"],
                  ...
                  let url = URL(string: bundleURL)
        {
            ...
            self.workerBaseURL = URL(string: "https://noizee-lastfm.betogzo.workers.dev")!
        }
    }
