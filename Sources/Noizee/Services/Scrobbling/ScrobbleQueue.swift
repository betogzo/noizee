...
/// Serializes to JSON in `~/Library/Application Support/Noizee/scrobble-queue.json`.
...
final class ScrobbleQueue {
    ...
    /// - Parameter directory: Directory for queue file. Defaults to Application Support/Noizee.
    ...
    private static func defaultDirectory() -> URL {
        ...
        return appSupport.appendingPathComponent("Noizee")
    }
}
