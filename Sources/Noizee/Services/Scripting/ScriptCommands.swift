...
@objc(NoizeePreviousTrackCommand)
...
@objc(NoizeeToggleShuffleCommand)
...
@objc(NoizeeGetPlayerInfoCommand)
...
/// This is a synchronous operation.
@objc(NoizeeDislikeTrackCommand)
