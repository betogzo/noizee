...
final class PlayerService: NSObject, PlayerServiceProtocol {
    ...
    /// in `NoizeeApp.init()` before any AppleScript commands can be received, and is never
    ...
    static let queueDisplayModeKey = "noizee.queue.displayMode"
    ...
    var isNoizeeInitiatedPlayback: Bool = false
