...
extension PlayerService {
    ...
    private static let savedQueueKey = "noizee.saved.queue"
    private static let savedQueueIndexKey = "noizee.saved.queueIndex"
    private static let savedPlaybackSessionKey = "noizee.saved.playbackSession"
